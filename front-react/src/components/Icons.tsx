...
export const DeviceCardIcon: React.FC<{ className?: string }> = ({ className }) => (
...
export const PhoneIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.12 2h3a2 2 0 0 1 2 1.72 12.81 12.81 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8 9a16 16 0 0 0 7 7l.36-.36a2 2 0 0 1 2.11-.45 12.81 12.81 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/>
  </svg>
);
...
export const ChatIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <path d="M21 11.5a8.38 8.38 0 0 1-1.9 5.4 8.5 8.5 0 0 1-6.6 3.1 8.38 8.38 0 0 1-5.4-1.9L3 21l1.9-4.1A8.38 8.38 0 0 1 3 11.5 8.5 8.5 0 0 1 6.1 4.9 8.38 8.38 0 0 1 11.5 3h1a8.5 8.5 0 0 1 8.5 8.5Z"/>
...
export const IdeaIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <path d="M9 18h6"/>
    <path d="M10 22h4"/>
    <path d="M12 2a7 7 0 0 1 4 12.7c-.8.5-1 1.1-1 1.8v.5H9v-.5c0-.7-.2-1.3-1-1.8A7 7 0 0 1 12 2Z"/>
  </svg>
);
...
export const RocketIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <path d="M4 13s1.5-1 5-1 5-2 5-2l5-5s1 3-1 7-4 6-4 6l-6-6"/>
    <path d="M2 15s2-2 5-2"/>
    <path d="M9 18s-2 2-5 2c0 0 0-3 2-5"/>
  </svg>
);
...
export const StatusIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <path d="M3 12h3"/>
    <path d="M12 3v3"/>
    <path d="M7.8 7.8 5.6 5.6"/>
    <path d="M16.2 7.8l2.2-2.2"/>
    <path d="M12 12l5 5"/>
    <circle cx="12" cy="12" r="9"/>
    <path d="M12 16a4 4 0 1 1 4-4"/>
  </svg>
);
